...
$(document).ready(function() {     
      ...
      $('#newsletter-form').ajaxChimp({
        ...
        url:'//handark.us7.list-manage.com/subscribe/post?u=a8c8d94e5a2f60fb052cbe3f3&amp;id=a36f36d169'
      });
      ...
      function callbackFunction (resp) {
          ...
          if (resp.result === 'success') {
            $(".subscribe-message").html('<i class="fa fa-check"></i> Le hemos enviado un correo de confirmación.').fadeIn().css("color","#fff");
          }
          else{
            var msg = resp.msg.split("-")[1];
            $(".subscribe-message").html('<i class="fa fa-warning"></i> Por favor ingrese una dirección de correo valida.').fadeIn().css("color","#ef4b4b");
